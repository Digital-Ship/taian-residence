    ...
    <main>
        <section id="lp-main">
            <div class="container lp-main-content_box_inner">
                ...
                <div class="abs-item txt_debut">
                    <img src="<?php echo $Path; ?>/images/lp/main/grand-debut-txt.svg" alt="2022.GRAND DEBUT" width="59"
                        height="272">
                </div>
                ...
                <div class="abs-item group-action">
                    ...
                    <a href="<?php echo $Path; ?>inquiry.php" class="btn-inquiry">
                        <img src="<?php echo $Path; ?>/images/lp/main/icon-letter.svg" alt="メールマーク" width="55"
                            height="42">
                    </a>
                </div>
                <div class="abs-item residence">
                    ...
                    <div class="residence__img">
                        <img src="<?php echo $Path; ?>/images/lp/main/lp-residence-txt.svg" alt="RESIDENCE" width="333"
                            height="47">
                    </div>
                </div>
        ...
        <section id="concept">
            <div class="container">
                ...
                <div class="concept-content">
                    ...
                    <img class="hidden-pc" src="<?php echo $Path; ?>/images/lp/concept/img1.png"
                        alt="安心・安全で世代を超える住まいを創造" width="750" height="250" />
                    <img class="concept__img hidden-pc" src="<?php echo $Path; ?>/images/lp/concept/img2.png"
                        alt="安心・安全で世代を超える住まいを創造" width="750" height="580" />
                    <p class="note">
        ...
        <section id="image-view">
            <div class="image_view_wrap">
                <h2 class="image_view__title"><img src="<?php echo $Path; ?>/images/lp/image_view/txt_image_view.svg"
                        alt="IMAGE VIEW" width="417" height="47"></h2>
                <div class="image_view_content">
                    ...
                    <p class="image_view__txt_jp">
                        <img src="<?php echo $Path; ?>/images/lp/image_view/txt_image_view_jp.svg" alt="" width="153"
                            height="415">
                    </p>
            ...
            <div class="wrap">
                ...
                <div class="__car">
                    <div class="__car_content">
                        ...
                        お子様の送迎や来客時などにも困らない2台分の駐車<br class="hidden-pc" />スペースも確保（車種による）。<br
                            class="hidden-pc" />ビルトインカーポートですので<br class="hidden-pc" />愛車にも優しい駐車スペース<br
                            class="hidden-pc" />となっております。
        ...
        <section id="plan">
            ...
            <div class="__plan _plan_a btn_open_popup" data-popup="#popup-plan-a">
                <div class="plan__content ">
                    <img class="plan_txt" src="<?php echo $Path; ?>/images/lp/plan/txt_taian_residence.svg"
                        alt="TAIAN RESIDENCE">
            ...
            <section id="equipment">
                <div class="equipment-wrap">
                    ...
                    <div class="equipment-box right">
                        ...
                        <div class="box__img">
                            <img class="hidden-pc" src="<?php echo $Path; ?>/images/lp/equipment/img_kitchen.png"
                                alt="KITCHEN">
                            <img class="hidden-sp" src="<?php echo $Path; ?>/images/lp/equipment/img_kitchen_2.png"
                                alt="KITCHEN">
                    ...
                    <div class="equipment-box left">
                        ...
                        <div class="box__img">
                            <img class="hidden-pc" src="<?php echo $Path; ?>/images/lp/equipment/img_bath_room.png"
                                alt="BATH ROOM">
                            <img class="hidden-sp" src="<?php echo $Path; ?>/images/lp/equipment/img_bath_room_2.png"
                                alt="BATH ROOM">
                    ...
                    <div class="equipment-box right">
                        ...
                        <div class="box__img">
                            <img class="hidden-pc" src="<?php echo $Path; ?>/images/lp/equipment/img_wash_stand.png"
                                alt="WASH STAND">
                            <img class="hidden-sp" src="<?php echo $Path; ?>/images/lp/equipment/img_wash_stand_2.png"
                                alt="WASH STAND">
                    ...
                    <div class="equipment-box left last">
                        ...
                        <div class="box__img">
                            <img class="hidden-pc" src="<?php echo $Path; ?>/images/lp/equipment/img_accent_tile.png"
                                alt="ACCENT TILE">
                            <img class="hidden-sp" src="<?php echo $Path; ?>/images/lp/equipment/img_accent_tile_2.png"
                                alt="ACCENT TILE">
                        ...
                        <div class="box__desc">
                            ...
                            <div class="btn__group">
                                <div class="btn_item"><img
                                        src="<?php echo $Path; ?>/images/lp/equipment/img_accent_tile_img1.png"
                                        alt="ACCENT TILE 1">
                                </div>
                                <div class="btn_item">
                                    <img src="<?php echo $Path; ?>/images/lp/equipment/img_accent_tile_img2.png"
                                        alt="ACCENT TILE 2">
                                </div>
                            </div>
                        </div>
                ...
                <div class="structure_wrap">
                    ...
                    <div class="strong_point">
                        <div class="point_item">
                            <div class="point">
                                <img src="<?php echo $Path; ?>/images/lp/structure/strong_point_1.svg"
                                    alt="STRONG POINT 1">
                                <div class="point_txt">
                        ...
                        <div class="point_item">
                            <div class="point">
                                <img src="<?php echo $Path; ?>/images/lp/structure/strong_point_2.svg"
                                    alt="STRONG POINT 2">
                                <div class="point_txt">
                        ...
                        <div class="point_item">
                            <div class="point">
                                <img src="<?php echo $Path; ?>/images/lp/structure/strong_point_3.svg"
                                    alt="STRONG POINT 3">
                                <div class="point_txt">
                        ...
                        <div class="point_item">
                            <div class="point">
                                <img src="<?php echo $Path; ?>/images/lp/structure/strong_point_4.svg"
                                    alt="STRONG POINT 4">
                                <div class="point_txt">
                    ...
                    <div class="structure_bot">
                        ...
                        <div class="structure_bot_wrap">
                            <img class="hidden-pc" src="<?php echo $Path; ?>/images/lp/structure/img.png"
                                alt="モノコック構造を採用しています">
                            <div class="structure_bot_wrap_txt">
                                ...
                                <div class="imgs">
                                    <img src="<?php echo $Path; ?>/images/lp/structure/img2.png"
                                        alt="モノコック構造を採用しています 2">
                                    <img src="<?php echo $Path; ?>/images/lp/structure/img3.png"
                                        alt="モノコック構造を採用しています 3">
                                </div>
                            </div>
        ...
        <section id="life_information">
            ...
            <div id="shonan_area">
                ...
                <div class="shonan_area__content">
                    ...
                    <p>
                        詳しくはFUJISAWA MAPからもご確認いただけます。<br class="hidden-pc" /><a
                            href="https://webgis.alandis.jp/fujisawa14/portal/kikendo/index.html"
                            target="_blank">https://webgis.alandis.jp/fujisawa14/portal/kikendo/index.html</a>
                    </p>
                </div>
            </div>
            <div id="google-map">
